#!/usr/bin/env python3
"""
Convert markdown files to PDF with custom diagram sizing and proper bullet formatting
"""
...
def get_diagram_size_for_week(week_num):
    ...
    week_sizes = {
        '03': '100%',  # Chapter 3 - make it 100%
        '04': '70%',   # Chapter 4 - default
        '05': '70%',   # Chapter 5 - default
        '06': '100%',  # Chapter 6 - make it 100%
        '07': '70%',   # Chapter 7 - default
        '08': '70%',   # Chapter 8 - default
        '09': '70%',   # Chapter 9 - default
        '10': '100%',  # Chapter 10 - make it 100%
        '11': '70%',   # Chapter 11 - default
        '12': '50%',   # Chapter 12 - too big, make it 50%
        '13': '100%',  # Chapter 13 - make it 100%
    }
        ...
        if week_num:
            ...
            if png_path.exists():
                ...
                if base64_data:
                    ...
                    return f"\n![Mermaid Diagram {diagram_counter}]({base64_data}){{.diagram-size-{diagram_size.replace('%', '')}}}\n"
                else:
                    # Fallback to file path
                    return f"\n![Mermaid Diagram {diagram_counter}]({png_path}){{.diagram-size-{diagram_size.replace('%', '')}}}\n"
            else:
...
<head>
    ...
    <style>
        ...
        /* Fix for bullet points in paragraphs */
        p > ul, p > ol {{
            display: block;
            margin: 10px 0;
        }}
...
def convert_all_to_pdf():
    ...
    print("   Custom diagram sizing per chapter")
    print("   Improved bullet point formatting\n")
