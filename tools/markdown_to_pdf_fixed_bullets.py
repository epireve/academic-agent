...
def get_diagram_size_for_week(week_num):
    ...
    week_sizes = {
        '01': '100%',  # Chapter 1 - make it 100%
        '03': '100%',  # Chapter 3 - make it 100%
        '04': '30%',   # Chapter 4 - make it 30%
        '05': '100%',  # Chapter 5 - make it 100%
        '06': '100%',  # Chapter 6 - make it 100%
        '07': '70%',   # Chapter 7 - default
        '08': '100%',  # Chapter 8 - make it 100%
        '09': '100%',  # Chapter 9 - make it 100%
        '10': '100%',  # Chapter 10 - make it 100%
        '11': '70%',   # Chapter 11 - default
        '12': '30%',   # Chapter 12 - make it 30%
    ...
    while i < len(lines):
        ...
        if line.strip().startswith('*'):
            ...
            if i + 1 < len(lines) and lines[i + 1].strip() and not lines[i + 1].strip().startswith('*'):
                ...
                # Look for patterns like "* Something:" at the start
